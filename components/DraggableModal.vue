...
.resize-handle.e { top: 10px; bottom: 10px; right: -5px; width: 10px; cursor: e-resize; }
.resize-handle.w { top: 10px; bottom: 10px; left: -5px; width: 10px; cursor: w-resize; }

.resize-handle.ne { top: -5px; right: -5px; width: 12px; height: 12px; cursor: ne-resize; }
.resize-handle.nw { top: -5px; left: -5px; width: 12px; height: 12px; cursor: nw-resize; }
.resize-handle.se { bottom: -5px; right: -5px; width: 12px; height: 12px; cursor: se-resize; }
.resize-handle.sw { bottom: -5px; left: -5px; width: 12px; height: 12px; cursor: sw-resize; }
</style>