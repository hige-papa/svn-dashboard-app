                ...
                <div class="role-options">
                  <div class="role-option">
                    ...
                    <label for="roleAdmin" class="role-label">
                      <i class="mdi mdi-shield-crown icon"></i>
                      <div class="role-info">
                        <div class="role-name">管理者</div>
                        <div class="role-description">全ての機能にアクセス可能</div>
                      </div>
                    </label>
                  </div>
                  <div class="role-option">
                    ...
                    <label for="roleUser" class="role-label">
                      <i class="mdi mdi-account icon"></i>
                      <div class="role-info">
                        <div class="role-name">一般ユーザー</div>
                        <div class="role-description">基本機能の利用が可能</div>
                      </div>
                    </label>
                  </div>
                  <div class="role-option">
                    <input 
                      ...
                      @change="clearError('role')"
                    >
                    <label for="roleViewer" class="role-label">
                      <i class="mdi mdi-eye icon"></i>
                      <div class="role-info">
                        <div class="role-name">閲覧者</div>
                        <div class="role-description">閲覧のみ可能</div>
                      </div>
                    </label>
                  </div>
                </div>
                ...
                <div class="status-options">
                  <div class="status-option">
                    <input 
                      ...
                      class="status-radio"
                    >
                    <label for="statusActive" class="status-label active">
                  ...
                  <div class="status-option">
                    <input 
                      ...
                      class="status-radio"
                    >
                    <label for="statusInactive" class="status-label inactive">
                      <i class="mdi mdi-pause-circle icon"></i>
                      無効
                    </label>
                  </div>
                </div>
...
const handleSubmit = async () => {
  ...
  try {
    if (isEditMode.value) {
      ...
      await createUserProfile(formData.email, formData.password, profileData)
