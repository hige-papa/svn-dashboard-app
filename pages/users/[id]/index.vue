    ...
    <div v-if="showDeleteDialog" class="dialog-overlay" @click="closeDeleteDialog">
      <div class="dialog-content" @click.stop>
        ...
        <div class="dialog-body">
          <p><strong>{{ userProfile?.displayName }}</strong> を削除しようとしています。</p>
...
useHead({
  title: 'TASCAL - ユーザー詳細',
  meta: [
    { name: 'description', content: 'TASCALシステムのユーザー詳細情報を表示します' }
  ],
  link: [
...
const confirmDelete = async () => {
  try {
    ...
    await deleteUserProfile(userId.value)
