      ...
      <div class="content">
          ...
          <div class="profile-section">
            ...
            <div class="avatar-display-section">
              ...
              <div class="avatar-info">
                <p class="avatar-text">
                  {{ item.imageUrl ? '部課画像が設定されています' : '部課画像が設定されていません' }}
                </p>
              </div>
            </div>
          </div>
        ...
        <div v-else class="error-container">
          <div class="error-message">
            ...
            <h3>部課情報が見つかりません</h3>
            <p>指定された部課は存在しないか、アクセス権限がありません。</p>
...
const { getAsync, deleteAsync } = useSection()

// SEOメタタグ設定
useHead({
  title: 'TASCAL - 部課詳細',
  meta: [
    { name: 'description', content: 'TASCALシステムの部課詳細情報を表示します' }
  ],
  link: [
...
const item = ref<Section | null>(null)
...
const handleEdit = () => {
  push(`/section/${itemId.value}/edit`)
}
